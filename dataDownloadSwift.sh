...
function usage() {
    ...
    echo "    -b,--bucket <switf_container>      REQUIRED: The bucket in Swift where the file will be downloaded from"
    echo "    -f,--file <file>                   REQUIRED: The file to download from Swift\n"
    exit 0
}
